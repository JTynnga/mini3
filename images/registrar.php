    ...
    <section id="container">
        ...
        <nav class="nav-i">
            ...
            <div id="open" class=" open-i">
                ...
                <svg id="spin" class=" collapse1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="black" viewBox="-8 0 30 10">
            ...
            <ul id="toggle">
                <div class="infop">
                    <a href="registrar.php">
                        <svg class="svg-i" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="gray" viewBox="0 0 20 20">
                ...
                <div class="info-i">
                    <a href="registrar.php" class="registrar>
                            <svg class=" icon-r" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="gray" viewBox="0 0 20 18">
                ...
                <div class="logout">
                    <a href="logout.php">
                        <svg class="svg-ii" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 16">
